...
const { cycle, reset } = courseRegistrationsSlice.actions;
...
const Cycle = (token) => async (dispatch) => {
  ...
  try {
    const response = await axios({
      method: "get",
      url: `${C.localUrl}courses/registrations`,
      headers: {
...
export const CourseRegistrationsActions = {
  Cycle,
  Reset,
};

export default courseRegistrationsSlice.reducer;
